...
def index(request):
    try:
        ...
        archive_list = Article.objects.get_date()
        #浏览排行
        click_list = Article.objects.click_count()
...
def article_list(request):
    article_list_all = Article.objects.all()
...
def article(request):
    try:
        ...
        # 获取评论信息
        comments = Comment.objects.filter(id=article).order_by('id')
        comment_list = []
